...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, target_global_position=None):
        ...
        self.check_state = {}
        self.targetlongitudeDelta = - 0.003
        self.targetlatitudeDelta = + 0.001
...
if __name__ == "__main__":
    ...
    parser.add_argument('--targ_lon', type=str, help="Target longitude")
    parser.add_argument('--targ_lat', type=str, help="Target latitude")
    parser.add_argument('--targ_alt', type=str, help="Target altitude")
    args = parser.parse_args()
    target_global_position = np.fromstring(f'{args.targ_lon},{args.targ_lat},{args.targ_alt}', dtype='Float64', sep=',')
    print(target_global_position)
    conn = MavlinkConnection('tcp:{0}:{1}'.format(args.host, args.port), timeout=60)
    drone = MotionPlanning(conn, target_global_position=target_global_position)
    time.sleep(1)
